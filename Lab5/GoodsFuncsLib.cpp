...
namespace GoodsFuncs {
    ...
    GoodsFuncs GoodsFuncs::operator+(GoodsFuncs goods) {
        GoodsFuncs tmp;
    ...
    GoodsFuncs GoodsFuncs::operator*(int n) {
        GoodsFuncs tmp = GoodsFuncs(this->name, this->registrationDate, this->price, this->amount, this->invoiceNumber);
        tmp.amount *= n;
